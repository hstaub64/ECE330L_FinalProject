...
// 0 = P1 placing  (Player_Map,  P1_Hits)
// 1 = P2 placing  (Player2_Map, P2_Hits)
// 2 = P1 shooting (Player2_Map, P1_Hits)
// 3 = P2 shooting (Player_Map,  P2_Hits)
...
void SysTick_Handler(void)
{
  ...
  if (Cursor_On > 0)
  {
      ...
      {
          Delay_counter = 0;
          Composite_Display(Player_Map, P1_Hits);  // hardcode for now
      }
  }
